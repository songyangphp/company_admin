<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpStudy\WWW\FastAdmin\public/../application/admin\view\companymap\test1.html";i:1530069611;s:68:"D:\phpStudy\WWW\FastAdmin\application\admin\view\layout\default.html";i:1523974191;s:65:"D:\phpStudy\WWW\FastAdmin\application\admin\view\common\meta.html";i:1529971551;s:67:"D:\phpStudy\WWW\FastAdmin\application\admin\view\common\script.html";i:1523974191;}*/ ?>
<!DOCTYPE html>
...
<form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="lon" data-rule="required" class="form-control" name="row[lon]" type="text" value="<?php echo $row['lon']; ?>" disabled >
        </div>
    </div>
    <div class="form-group">
        <label for="c-lat" class="control-label col-xs-12 col-sm-2">纬度:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="lat" data-rule="required" class="form-control" name="row[lat]" type="text" value="<?php echo $row['lat']; ?>" disabled >
        </div>
    </div>
    <div class="form-group">
