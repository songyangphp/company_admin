<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpStudy\WWW\FastAdmin\public/../application/admin\view\companymanager\edit.html";i:1529912950;s:68:"D:\phpStudy\WWW\FastAdmin\application\admin\view\layout\default.html";i:1523974191;s:65:"D:\phpStudy\WWW\FastAdmin\application\admin\view\common\meta.html";i:1529971551;s:67:"D:\phpStudy\WWW\FastAdmin\application\admin\view\common\script.html";i:1523974191;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select  id="c-b_id" data-rule="required" class="form-control selectpicker" name="row[b_id]">
                <?php if(is_array($building) || $building instanceof \think\Collection || $building instanceof \think\Paginator): if( count($building)==0 ) : echo "" ;else: foreach($building as $key=>$vo): ?>
                <option value="<?php echo $vo['id']; ?>" <?php if(in_array(($vo['id']), is_array($row['b_id'])?$row['b_id']:explode(',',$row['b_id']))): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
