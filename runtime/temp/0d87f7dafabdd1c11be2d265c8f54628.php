<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\phpStudy\WWW\FastAdmin\public/../application/admin\view\dashboard\index.html";i:1530927652;s:68:"D:\phpStudy\WWW\FastAdmin\application\admin\view\layout\default.html";i:1523974191;s:65:"D:\phpStudy\WWW\FastAdmin\application\admin\view\common\meta.html";i:1529971551;s:67:"D:\phpStudy\WWW\FastAdmin\application\admin\view\common\script.html";i:1523974191;}*/ ?>
<!DOCTYPE html>
...
<div class="panel panel-default panel-intro">
    <!--<div class="panel-heading">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#one" data-toggle="tab">石家庄企业监管平台</a></li>
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-red"><i class="glyphicon glyphicon-thumbs-up"></i></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-violet"><i class="glyphicon glyphicon-hand-right"></i></span>
                            <div class="sm-st-info">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-blue"><i class="glyphicon glyphicon-hand-left"></i></span>
                            <div class="sm-st-info">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="glyphicon glyphicon-hand-up"></i></span>
                            <div class="sm-st-info">
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    <div class="col-xs-6 stat-col">
                                        <div class="stat-icon"> <i class="glyphicon glyphicon-exclamation-sign" style="color: rgb(255, 152, 0)"></i> </div>
                                        <div class="stat">
                                            <div class="value"> <?php echo $yichang; ?> </div>
                                            <div class="name"> 异常企业 </div>
                                        </div>
                                        <div class="progress">
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        <div class="stat-icon"> <i class="glyphicon glyphicon-ban-circle" style="color: rgb(255, 0, 0)"></i> </div>
                                        <div class="stat">
                                            <div class="value"> <?php echo $diaoxiao; ?> </div>
                                            <div class="name"> 吊销企业 </div>
                                        </div>
                                        <div class="progress">
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        <div class="stat-icon"> <i class="fa fa-users" style="color: rgb(0, 0, 0);"></i> </div>
                                        <div class="stat">
                                            <div class="value"> 17 </div>
                                            <div class="name"> 未提报年报信息 </div>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-blue" style="width: 25%"></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6  stat-col">
                    ...
                    <div class="col-lg-4">
                        <div class="box box-danger">
                            <div class="box-header">
                                <h3 class="box-title">异常企业</h3>
                                <div class="box-tools pull-right">
                                    <a href="https://www.fastadmin.net" target="_blank" class="btn btn-box-tool"></a>
                                </div>
                            </div>
                            <div class="box-body">
                                <table class="table table-striped">
                                    <tbody>
                                    <tr>
                                        <td width="405"><b>企业名称</b></td>
                                        <td><b>列异日期</b></td>
                                    </tr>
                                    <?php if(is_array($yclist) || $yclist instanceof \think\Collection || $yclist instanceof \think\Paginator): if( count($yclist)==0 ) : echo "" ;else: foreach($yclist as $key=>$vo): ?>
                                    <tr>
                                        <td width="405"><?php echo $vo['company_name']; ?></td>
                                        <td><?php echo $vo['ly_time']; ?></td>
                                    </tr>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <table class="table table-striped">
                                    ...
                                    <?php if(is_array($dslist) || $dslist instanceof \think\Collection || $dslist instanceof \think\Paginator): if( count($dslist)==0 ) : echo "" ;else: foreach($dslist as $key=>$vo): ?>
                                    <tr>
                                        <td width="405"><?php echo $vo['aj_name']; ?></td>
                                        <td><?php echo $vo['ja_time']; ?></td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </tbody>
                                </table>
